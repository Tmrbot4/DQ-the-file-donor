...
BOT_TOKEN = environ['6658818420:AAGppVsx9YpAloxQTtYwKktbvez5-4KLCbo']
...
auth_channel = environ.get('-1002122286833')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('-1002071894874')
reqst_channel = environ.get('-1002043803005')
...
VERIFY2_API = environ.get('VERIFY2_API', "8cefe6e80dc4dd1f046e74f32e3d3fee248306f3")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Entertainment_Hubbb')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('-1002086093131', 0))
